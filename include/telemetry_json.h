...
/* Truck */
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TelemetryTruckCabin,offset,angularAcceleration,
                                   angularVelocity)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TelemetryTruckInput,brake,throttle,clutch,steering)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TelemetryTruckBrake,retarder,parking,motor,
                                   airPressure,airPressureWarning,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TelemetryTruckAdblue,amount,
                                   averageConsumption,warning)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TelemetryTruckLight,leftBlinker,rightBlinker,
                                   parking,lowBeam,highBeam,auxFront,auxRoof,
                                   beacon,brake,reverse)
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TelemetryTruckNavigation,distance,time,
                                   speed_limit)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TelemetryTruckConfig,brand,brandId,id,name,
                                   fuelCapacity,fuelWarningFactor,
                                   adblueCapacity,adblueWarningFactor,
                                   airPressureWarning,airPressureEmergency,
                                   oilPressureWarning,waterTemperatureWarning, 
                                   batteryVoltageWarning,rpmLimit,
                                   forwardGearCount,reverseGearCount,
                                   retarderStepCount,cabinPosition,
                                   hookPosition,headPosition,licensePlate,
                                   licensePlateCountry,licensePlateCountryId,
                                   wheelCount,shifterType)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TelemetryTruck,config,worldPlacement,
                                   localLinearVelocity,localLinearAcceleration,
                                   localAngularVelocity,
                                   localAngularAcceleration,cabin,headOffset,
                                   speed,engine,displayedGear,input,effective,
                                   cruiseControl,brake,fuel,adblue,oil,
                                   waterTemperature,waterTemperatureWarning,
                                   batteryVoltage,batteryVoltageWarning,
                                   electricEnabled,leftBlinker,
                                   rightBlinker,hazardWarning,differentialLock,
                                   light,wipers,dashboardBacklight,liftAxle,
                                   liftAxleIndicator,trailerLiftAxle,
                                   trailerLiftAxleIndicator,wheels,wear,
                                   odometer,navigation)

/* Trailer */
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TelemetryTrailerConfig,id,cargoAccessoryId,
                                   hookPosition,brandId,brand,name,licensePlate,
                                   licensePlateCountry,licensePlateCountryId,
                                   chainType,bodyType,wheelCount)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TelemetryTrailerWear,body,chassis,
                                   wheels)
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TelemetryJob,cargo,cargoId,cargoUnitCount,
                                   ...
                                   destinationCityId,sourceCity,
                                   sourceCityId,destinationCompany,
                                   destinationCompanyId,
                                   sourceCompany,sourceCompanyId,
                                   jobMarket,isCargoLoaded,isSpecialJob,
                                   cargoDamage)
