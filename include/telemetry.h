...
#define GAMEPLAY_ATTR_VARIANT                                                  \
  std::variant<std::string, scs_float_t, scs_double_t, scs_s32_t, scs_s64_t,   \
               scs_u32_t, scs_u64_t, bool>
...
template <typename T> struct TelemetryPayload {
